	...
	<body>
		<nav class="navbar navbar-dark navbar-expand-md py-3">
			<div class="container">
				<a class="navbar-brand d-flex align-items-center" href="#">
					<span
						class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon">
						<svg
			...
			<div class="container">
				...
				<?php
					...
					foreach ($teams as $team) {
						...
						<div class="col">
							<div>
								<img class="rounded img-fluid d-block w-100" style="height: 200px" src="<?php echo $image; ?>" />
				...
				?>
					<!-- <div class="col">
						<div>
							<img
								class="rounded img-fluid d-block w-100"
								style="height: 200px"
								src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" />
							<div class="py-4 text-center">
								<h4>Team Name</h4>
		...
		<footer class="text-center">
			<div class="container text-center">
				<h4 class="fw-bold">AXS Lampung</h4>
				<p class="mb-4">Independent We Stand. Brotherhood No Limit</p>
				...
				<p class="mb-0">Copyright © 2023 AXS Lampung</p>
			</div>
		</footer>
